...
RESULT=${RESULT:-./result/infer_custom_benchmark/${TIME_STR}.jsonl}

echo "=== Inference custom_benchmark... Model: ${MODEL} Time: ${TIME_STR} ==="
...
uv run --no-sync swift infer \
	...
	--infer_backend vllm \
	--val_dataset ./custom_benchmark.jsonl \
	--temperature 0 \
...
echo "=== Eval custom_benchmark... Model: ${MODEL} Time: ${TIME_STR} ==="
